...
package com.zwg.huibenlib.Utils.video;
...
public class MyUniversalVideoView extends SurfaceView
    ...
    private ErrorVideoLinstener errorVideoLinstener;

    public ErrorVideoLinstener getErrorVideoLinstener() {
        return errorVideoLinstener;
    }

    public void setErrorVideoLinstener(ErrorVideoLinstener errorVideoLinstener) {
        this.errorVideoLinstener = errorVideoLinstener;
    }
    ...
    private void openVideo() {
        ...
        try {
            ...
            if(ex.toString().contains("setDataSourceFD failed")){
                ...
                if(errorVideoLinstener!=null){
                    errorVideoLinstener.errorLinstener();
                }else {
                    ShowOtherDia showOtherDia=new ShowOtherDia(mContext,R.style.NobackDialog,"播放失败\n视频文件可能已损坏");
                    showOtherDia.show();
                }
