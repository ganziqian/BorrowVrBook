...
package com.zwg.huibenlib.SampleApplication;
...
import com.zwg.huibenlib.Utils.Vuforia_contants;
...
public class SampleApplicationSession implements UpdateCallbackInterface
{
    ...
    public void initAR(AppCompatActivity activity, int screenOrientation)
    {
        SampleApplicationException vuforiaException = null;
        mActivity = activity;
        Log.d(LOGTAG,"initAR..............1");
        ...
        Log.d(LOGTAG,"initAR..............2");
        if (mInitVuforiaTask != null)
        {
            Log.d(LOGTAG,"initAR..............2-1");
        ...
        Log.d(LOGTAG,"initAR..............3");
        if (vuforiaException == null)
        {
            try
            {
                Log.d(LOGTAG,"initAR..............3-1");
                mInitVuforiaTask = new InitVuforiaTask();
                mInitVuforiaTask.execute();
            } catch (Exception e)
            {
                Log.d(LOGTAG,"initAR..............3-2");
        ...
        Log.d(LOGTAG,"initAR..............4");
        if (vuforiaException != null) {
            Log.d(LOGTAG,"initAR..............4-1");
    ...
    public void stopAR() throws SampleApplicationException
    {
       ...
       /* FragmentManager manager=mActivity.getSupportFragmentManager();
        VuforiaFragment vuforiaFragment= (VuforiaFragment) manager.findFragmentByTag("myfrgment");
        if(vuforiaFragment!=null){
            vuforiaFragment.handler.sendEmptyMessage(46);
        }*/
    }
    ...
    private class InitVuforiaTask extends AsyncTask<Void, Integer, Boolean>
    {
        ...
        protected Boolean doInBackground(Void... params)
        {
            ...
            synchronized (mShutdownLock)
            {
                Vuforia.setInitParameters(mActivity, mVuforiaFlags, Vuforia_contants.app_key);
